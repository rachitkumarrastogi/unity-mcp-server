...
| Doc | Description |
|-----|-------------|
| [REGISTRY.md](./REGISTRY.md) | Publishing to the MCP Registry (details) |
| [COMPARISON_AND_RATING.md](./COMPARISON_AND_RATING.md) | Comparison with other Unity MCP servers |
